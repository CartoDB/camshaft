...
var gwrPredictTemplate = Node.getSqlTemplateFn('gwr');

var TYPE = 'gwr-predict';
var PARAMS = {
...
var GWRPredict = Node.create(TYPE, PARAMS, { cache: true, version: 1 });

module.exports = GWRPredict;

GWRPredict.prototype.sql = function() {
    return gwrPredictTemplate({
