...
LineSourceToTarget.prototype.checkLimits = function(databaseService, limits, callback) {
    if (this.closest) {
        NodeRequirements.limitSingleInputRows(this, 'source', databaseService, 1000000, limits, callback);
    }
    else {
        NodeRequirements.limitProductInputRows(this, databaseService, 1000000, limits, callback);
    }
};
