...
LineSourceToTarget.prototype.checkLimits = function(databaseService, limits, callback) {
    if (this.closest) {
        this.requirements.limitSingleInputRows('source', databaseService, 1000000, limits, callback);
    }
    else {
        this.requirements.limitProductInputRows(databaseService, 1000000, limits, callback);
    }
};
