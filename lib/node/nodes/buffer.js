...
Buffer.prototype.checkLimits = function(databaseService, limits, callback) {
    var defaultLimit;
    if (this.dissolved) {
        defaultLimit = 100000;
    }
    ...
    this.requirements.limitSingleInputRows('source', databaseService, limits, defaultLimit, callback);
};
