...
var queryTemplate = Node.template([
 ...
 GeoreferencePostalCode.prototype.checkLimits = function(databaseService, limits, logger, callback) {
     var defaultLimit;
     var limitName;
     ...
     var limit = NodeRequirements.getLimit(limits, TYPE, limitName, defaultLimit);
