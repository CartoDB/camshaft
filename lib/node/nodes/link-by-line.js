...
var PARAMS = {
    ...
    dest_points        : Node.PARAM.NODE(Node.GEOMETRY.POINT),
    id_column_source   : Node.PARAM.STRING(),
    id_column_dest     : Node.PARAM.STRING(),
...
var featureColumns = function(columns,prefix){
    return columns.filter(function(col){ 
        return ['the_geom','the_geom_webmercator','cartodb_id'].indexOf(col) == -1
    }).map(function(col){ 
