...
var debug = require('../../util/debug')('analysis:inersection');

var TYPE = 'intersection';
var PARAMS = {
    source: Node.PARAM.NODE(Node.GEOMETRY.ANY),
    source_columns: Node.PARAM.NULLABLE(Node.PARAM.ARRAY()),
    target: Node.PARAM.NODE(Node.GEOMETRY.ANY),
};

var Intersection = Node.create(TYPE, PARAMS, { cache: true, version: 3 });
...
Intersection.prototype.sql = function() {
    var sql = queryTemplate({
        ...
        columns: ['_cdb_analysis_target.*'].concat(this.source.getColumns(true).map(function (name) {
