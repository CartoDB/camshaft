...
var queryTemplate = Node.template([
 ...
 GeoreferenceAdminRegion.prototype.checkLimits = function(databaseService, limits, logger, callback) {
     var limit = NodeRequirements.getLimit(limits, TYPE, 'maximumNumberOfRows', 1000);
     NodeRequirements.limitSingleInputRows(this, 'source', databaseService, limit, logger, callback);
 };
