...
var queryTemplate = Node.template([
 ...
 GeoreferenceAdminRegion.prototype.checkLimits = function(databaseService, limits, callback) {
     NodeRequirements.limitSingleInputRows(this, 'source', databaseService, limits, 1000, callback);
 };
