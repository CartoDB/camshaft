...
var PARAMS = {
    ...
    numberOfNeighbours: Node.PARAM.NULLABLE(Node.PARAM.NUMBER(),0),
    // IDW: decay order, 0 -> order 1
    decayOrder: Node.PARAM.NULLABLE(Node.PARAM.NUMBER(),0)
};
...
Enrich.prototype.sql = function(){
    return enrichTemplate({
        ...
        method: ['nearest neighbor', 'barymetric','IDW'].indexOf[this.method],
