...
function limitNumberOfRows(node, databaseService, limit, callback) {
...
function limitMaxInputRows(node, databaseService, limit, callback) {
    if (!limit || !isFinite(limit)) {
        return callback(null);
    }
 ...
 function limitProductInputRows(node, databaseService, limit, callback) {
    if (!limit || !isFinite(limit)) {
        return callback(null);
    }
    estimatedNumberOfInputRows(node, databaseService, function(err, inputRows) {
...
function limitSingleInputRows(node, param, databaseService, limit, callback) {
    if (!limit || !isFinite(limit)) {
        return callback(null);
    }
    estimatedNumberOfInputRows(node, databaseService, function(err, inputRows) {
