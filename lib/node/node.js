...
module.exports.PARAM = {
    ...
    NUMBER: function() {
        return new Validator(TYPE.NUMBER, Number.isFinite);
    },
    STRING: function() {
        return new Validator(TYPE.STRING, function (str) {
            return typeof str === 'string';
        });
    },
    BOOLEAN: function() {
        return new Validator(TYPE.BOOLEAN, function (bool) {
    ...
    NULLABLE: function (validator) {
        ...
        }, true, validator.expects, validator.getDefaultValue());
    }
};
