...
Node.prototype.isOutdated = function() {
    ...
    var startingLastUpdate = (inputNodes.length > 0 ? null : this.getUpdatedAt());
    ...
    var nodeUpdatedAt = this.getUpdatedAt();
    return (nodeUpdatedAt === null || inputNodesLastUpdate.getTime() > nodeUpdatedAt.getTime());
};
